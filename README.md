...
<p align="center"> <a href="https://github.com/uni-halo/uni-halo" target="_blank" rel="noopener noreferrer">UniHalo v3.x</a>  多端应用的官方配套插件，Halo 2.x 站点装上即用。</p>
...
<p align="center">
	...
	<a href="https://github.com/uni-halo/uni-halo">应用仓库</a>
...
**UniHalo 配置插件** 是免费开源多端应用 [uni-halo](https://github.com/uni-halo/uni-halo)（微信小程序 / APP / H5）的配套插件。装在 [Halo 2.x](https://www.halo.run/) 站点上，即可在后台完成全部内容配置——文章轮播、公告、友链、恋爱日记等「改内容不改代码」，移动端即时生效；同时内置恋爱日记前台模板与移动端登录能力，主题零改造接入。
...
| 🖼️  | **前台模板**   | 内置恋爱日记前台模板，任何主题零成本接入，支持整页接管或覆盖页头页脚 |
...
插件内置恋爱日记前台模板，站点主题装上插件即可直接展示恋爱日记页面，支持整页接管或仅覆盖页头页脚。详见 [恋爱日记前台模板](https://uni-halo-doc.ialley.cn/plugin/love-template)。
...
- 2、在 Halo 插件市场搜索 `Uni Halo` 安装启用，或从 [插件 Releases](https://github.com/uni-halo/uni-halo-plugin/releases) 下载安装包上传安装。
...
- 提交 Issue：[GitHub Issues](https://github.com/uni-halo/uni-halo-plugin/issues)
- QQ 交流群：**632969367**
