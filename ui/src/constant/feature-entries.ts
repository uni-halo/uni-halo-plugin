...
export const FEATURE_ENTRY_REGISTRY: FeatureEntry[] = [
  ...
  {key: "user-agreement", title: "用户协议", subTitle: "站点用户协议", color: "#8D6E63", bgColor: "#8D6E6324", iconPrefix: "uhemoji2-icon", icon: "-wink", path: "/pages-blog/user-agreement/user-agreement", visible: true, group: "other"},
  {key: "privacy-policy", title: "隐私政策", subTitle: "站点隐私政策", color: "#A1887F", bgColor: "#A1887F24", iconPrefix: "uhemoji2-icon", icon: "-secret", path: "/pages-blog/privacy-policy/privacy-policy", visible: true, group: "other"},
];
